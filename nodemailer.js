...
sendEmailAll (priceObj) {
    ...
    let subject = `${priceObj.maxProfitCoin} Profit ${util.to2DecimalPlaces(priceObj.maxProfit)}`
    // setup email data with unicode symbols
    let mailOptions = {
        from: '"Neeraj Yadav" <neerajybkp3@gmail.com>', // sender address
        to: config.emailReceivers, // list of receivers
...
sendEmailReverseTransfer (priceObj) {
    // create reusable transporter object using the default SMTP transport
    let transporter = nodemailer.createTransport({
        host: 'smtp.gmail.com',
        port: 465,
    ...
    let subject = `You may transfer ${priceObj.maxAmountCexCoin} to get ${util.to2DecimalPlaces(priceObj.maxAmountCex)}`
    // setup email data with unicode symbols
    let mailOptions = {
        from: '"Neeraj Yadav" <neerajybkp3@gmail.com>', // sender address
        to: config.emailReceivers, // list of receivers
        ...
        <thead>
            <tr>
                <th>Coin in Cex</th>
                <th>Amount transferred (EUR)</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td>${util.to3DecimalPlaces(priceObj.ETH.coinBought)}</td>
                <td>${util.to3DecimalPlaces(priceObj.ETH.amountOnCex)}</td>
            </tr>
        </tbody>
        </table>
        </div>
        ...
        <tbody>
            <tr>
                <td>${util.to3DecimalPlaces(priceObj.XRP.coinBought)}</td>
                <td>${util.to3DecimalPlaces(priceObj.XRP.amountOnCex)}</td>
            </tr>
        </tbody>
        </table>
        </div>
        ...
        <tbody>
            <tr>
                <td>${util.to3DecimalPlaces(priceObj.BTC.coinBought)}</td>
                <td>${util.to3DecimalPlaces(priceObj.BTC.amountOnCex)}</td>
            </tr>
        </tbody>
        </table>
        </div>
        ...
        <tbody>
            <tr>
                <td>${util.to3DecimalPlaces(priceObj.BCH.coinBought)}</td>
                <td>${util.to3DecimalPlaces(priceObj.BCH.amountOnCex)}</td>
            </tr>
        </tbody>
        </table>
        </div>
